...
<OBJECT HEALING-SALVE
	(DESC "healing salve")
	(ACTION HEALING-SALVE-F)
	(QUANTITY 1)
	(FLAGS TAKEBIT)>

<ROUTINE HEALING-SALVE-F ()
	<COND (<CHECK-ITEM ,HEALING-SALVE>
		<COND (<L? ,STAMINA ,MAX-STAMINA>
			<CRLF>
			<TELL "Use the ">
			<PRINT-ITEM ,HEALING-SALVE T>
			<TELL " to heal up to ">
			<HLIGHT ,H-BOLD>
			<TELL "6">
			<HLIGHT 0>
			...
			<COND (<YES?>
				...
				<REMOVE-ITEM ,HEALING-SALVE ,TEXT-USED T T>
				<UPDATE-STATUS-LINE>
			)>
		)(ELSE
			...
			<COND (<YES?> <REMOVE-ITEM ,HEALING-SALVE "dropped" T T>)>
		)>
	)(ELSE
		<EMPHASIZE "You do not have a healing salve!">
	)>
	<RFALSE>>
...
<ROUTINE STORY-SHIPWRECK (STORY "OPT" JUMP-DROWNED JUMP-SURVIVE TEXT-SURVIVE "AUX" (RANK 1))
	<PUTP .STORY ,P?DOOM T>
	<SET RANK <GET-RANK ,CURRENT-CHARACTER>>
	<COND (<G? <RANDOM-EVENT 2 0 T> .RANK>
		...
		<TELL ,PERIOD-CR>
		<LOSE-STAMINA <ROLL-DICE 2> ,DIED-GREW-WEAKER .STORY>
...
<CONSTANT TEXT142 "This will be a test of your ingenuity, leadership and survival skills.">
...
<CONSTANT TEXT592-WHITE "You are swept miraculously towards a beach of soft white sand.">
...
<ROUTINE STORY592-EVENTS ()
	<STORY-SHIPWRECK ,STORY592 ,STORY123 ,STORY-LONE-LEVEL-SANDS ,TEXT592-WHITE>>
...
<CONSTANT TEXT631 "You step up to the great bronze door. Perched on a nearby rock, rigid as a sculpture, you notice a lizard glaring with wide, sightless eyes.">
...
<ROOM STORY631
	...
	(STORY TEXT631)
	(CHOICES CHOICES-MAGIC)
	(DESTINATIONS <PLTABLE <PLTABLE STORY667 STORY121>>)
	(REQUIREMENTS <PLTABLE <PLTABLE ABILITY-MAGIC 10>>)
	(TYPES ONE-ABILITY)
	(FLAGS LIGHTBIT)>

<CONSTANT TEXT632 "\"I knew it!\" he shrieks. \"The librarian sent you, didn't he? Well, just you tell him that I'll keep it as long as I want. I'm the Master! Me!\"||He flicks a spell of summary dispatch. The room disappears, there is a whirling kaleidoscope around you, then you find yourself plummeting out of a clear sky to land with a thud at the base of a tall oak.">
...
<CONSTANT TEXT633 "You retrace your steps until you are standing beside the shaft that the mine supervisor had boarded up. The tunnel you are in stretches back to the surface.">
<CONSTANT CHOICES633 <LTABLE "Go deeper into the mine" "Head for the surface">>
...
<ROOM STORY633
	...
	(STORY TEXT633)
	(CHOICES CHOICES633)
	(DESTINATIONS <PLTABLE STORY651 STORY394>)
	(TYPES TWO-CHOICES)
	(FLAGS LIGHTBIT)>

<CONSTANT TEXT634 "Helpless in the grip of the storm, the vessel cracks apart. The seawater rushes into the broken shell of the hull, dragging you down. The screams of your crewmen are drowned out by the howl of the storm.||You can think of nothing now but saving yourself.">
<CONSTANT TEXT634-ROCKY "You are swept miraculously towards a rocky shore.">
...
<ROUTINE STORY634-EVENTS ()
	<STORY-SHIPWRECK ,STORY634 ,STORY123 ,STORY-CITIES-GOLD-GLORY ,TEXT634-ROCKY>>

<CONSTANT TEXT635 "It is a priest of Elnir, who is gaining religious merit by walking between the many shrines and temples of his deity. \"Faith keeps my feet dry,\" he says. \"And devotion keeps my head pointed to the sky.\"||He delivers a stirring sermon that inspires your crew.">
<CONSTANT TEXT365-CONTINUE "The priest bids you good day and goes strolling off across the sea.">

<ROOM STORY635
	(IN ROOMS)
	(DESC "635")
	(STORY TEXT635)
	(EVENTS STORY635-EVENTS)
	(CONTINUE STORY116)
	(FLAGS LIGHTBIT)>

<ROUTINE STORY635-EVENTS ()
	<COND (,CURRENT-SHIP
		<COND (<EQUAL? <GETP ,CURRENT-SHIP ,P?CONDITION> ,CONDITION-POOR>
			<PUTP ,CURRENT-SHIP ,P?CONDITION ,CONDITION-AVERAGE>
		)>
	)>
	<COND (<CHECK-GOD ,GOD-ELNIR>
		<CONTINUE-TEXT "The priest gives you a healing salve (restores 1-6 Stamina). It can be used once when you are injured to give back one die roll of Stamina points.">
		<TAKE-ITEM ,HEALING-SALVE>
	)>
	<CONTINUE-TEXT ,TEXT365-CONTINUE>>

<CONSTANT TEXT636 "The ship manoeuvres out on to open ocean and is soon heading north under a full press of sail.">
...
<ROOM STORY636
	...
	(EVENTS STORY-SET-SAIL)
	(CHOICES CHOICES-RANDOM)
	(DESTINATIONS <PLTABLE <PLTABLE STORY-COURT-HIDDEN-FACES STORY636-SHIP-LOST STORY-COURT-HIDDEN-FACES>>)
	(REQUIREMENTS <PLTABLE <PLTABLE 1 0 <PLTABLE 1 2 6> <LTABLE "Captured by slavers" "The ship goes down in a storm, but you cling to a raft" "You reach Aku without incident">>>)
	(TYPES ONE-RANDOM)
	(FLAGS LIGHTBIT)>

<ROOM STORY636-SHIP-LOST
	(DESC "636")
	(BACKGROUND STORY636-BACKGROUND)
	(FLAGS LIGHTBIT)>

<ROUTINE STORY636-BACKGROUND ()
	<STORY-LOSE-SHIP>
	<RETURN ,STORY180>>

<CONSTANT TEXT637 "It isn't much of a boat -- just bundles of twigs and bracken lashed together to make a kind of crude pontoon. With fair weather and the kindness of the gods you might just stay afloat long enough to reach civilization.">
...
<ROOM STORY637
	...
	(LOCATION LOCATION-OCEAN)
	(STORY TEXT637)
	(EVENTS STORY637-EVENTS)
	(CHOICES CHOICES-RANDOM)
	(DESTINATIONS <PLTABLE <PLTABLE STORY123 STORY472 STORY505 STORY673>>)
	(REQUIREMENTS <LTABLE <LTABLE 1 0 <PLTABLE 2 4 5 7> <LTABLE "The boat sinks" "Picked up by pirates" "Swept ashore on an island" "Reach a port">>>)
	(TYPES ONE-RANDOM)
	(FLAGS LIGHTBIT)>

<ROUTINE STORY637-EVENTS ()
	<COND (<CHECK-PROFESSION ,PROFESSION-WAYFARER>
		<RESET-ODDS 1 1 ,STORY637>
	)(ELSE
		<RESET-ODDS 1 0 ,STORY637>
	)>>

<CONSTANT TEXT638 "You are chained to the wall of the Reaver King's throne room and flogged whenever he is in a bad temper -- which is often. Days turn into weeks and gradually your health declines.">
<CONSTANT TEXT638-CONTINUED "There eventually comes a time when you are too weak and battered to give the Reavers any sport. They sell you to slavers from Yarimura, who strip you of any possessions and money you may have managed to hold on to.">
...
<ROOM STORY638
	...
	(LOCATION LOCATION-REAVER)
	(STORY TEXT638)
	(EVENTS STORY638-EVENTS)
	(CONTINUE STORY-PLAINS-HOWLING-DARKNESS)
	(DOOM T)
	(FLAGS LIGHTBIT)>

<ROUTINE STORY638-EVENTS ()
	<LOSE-STAMINA <ROLL-DICE 3> ,DIED-FROM-INJURIES ,STORY638>
	<COND (<IS-ALIVE>
		<COND (<CHECK-CODEWORD ,CODEWORD-CROCUS> <DELETE-CODEWORD CODEWORD-CROCUS>)>
		<COND (<CHECK-CODEWORD ,CODEWORD-COLOUR> <DELETE-CODEWORD CODEWORD-COLOUR>)>
		<STORY-LOSE-EVERYTHING F>
		<CONTINUE-TEXT TEXT638-CONTINUED>
	)>>

<CONSTANT TEXT639 "You push your luck too far. You have many enemies -- among them a wealthy silk merchant who lost several of his shipments during your last outing as a pirate. He sets a price on your head that brings bounty hunters from all across the known world, and within a month you have been taken at sea. Your execution comes soon after.">
...
<CONSTANT TEXT640 "The scholars demand half of any cash you're carrying. They euphemistically describe this as moonlight tax, even though mist or drizzle mean that it is rarely possible to see the moon in Dweomer.">
...
<ROOM STORY640
	...
	(LOCATION LOCATION-DWEOMER)
	(STORY TEXT640)
	(EVENTS STORY640-EVENTS)
	(CONTINUE STORY571)
	(FLAGS LIGHTBIT)>

<ROUTINE STORY640-EVENTS ("AUX" COUNT FIRST)
	<COND (<G? ,MONEY 1>
		<LOSE-MONEY </ ,MONEY 2>>
	)(<EQUAL? ,MONEY 1>
		<LOSE-MONEY 1>
